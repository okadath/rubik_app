 ...
 * Use the [Tuto1.newInstance] factory method to
...
class Tuto1Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.floatingActionButton).setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_tuto1_to_nav_home)
        )
        view.findViewById<View>(R.id.floatingActionButton2).setOnClickListener(
            Navigation.createNavigateOnClickListener(R.id.action_tuto1_to_tuto2Fragment)
        )
    }
}